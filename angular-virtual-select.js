(function(window, angular) {
	...
	var virtualSelectModule = angular.module('angular-virtual-select', ['vs-repeat']).directive('virtualSelect', ['$filter', '$document', '$timeout', function($filter, $document, $timeout) {
		return {
			restrict: 'AE',
			replace: true,
			scope: {
			...
			templateUrl: 'virtualSelect/angular-virtual-select.tpl.html',
	...
	var virtualSelectFilterSelected = angular.module('angular-virtual-select').filter('filterSelected', function() {
